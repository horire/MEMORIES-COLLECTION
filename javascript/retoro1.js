...
const imgretoro1 = new Image();
imgretoro1.src = '../images/retoro-1.png';
...
const drawCanvas = (text, time, day, price, sc, seat, free) => {
    ctx.drawImage(imgretoro1, 0, 0, 463, 406);
    ctx.font = "20px sans-serif";
    ctx.fillStyle = "#1F1F09";
    ctx.textAlign = "left";
    ...
    ctx.fillStyle = "#FEF6EC";
    ctx.textAlign = "center";
    ctx.fillText(sc, 55, 290);
    ctx.font = "25px sans-serif";
    ctx.fillStyle = "#1F1F09";
    ctx.textAlign = "left";
    ctx.fillText(seat, 110, 295);
    ...
    freeLines.forEach((line, idx) => {
        ctx.fillText(line, 20, 355 + idx * lineHeight);
    });
