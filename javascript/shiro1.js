...
const imgShiro1 = new Image();
imgShiro1.src = '../images/shiro-1.png';
...
const drawCanvas = (text, time, day, price, sc, seat, free) => {
    ctx.drawImage(imgShiro1, 0, 0, 463, 406);
    ...
    ctx.fillText(sc, 55, 300);
    ctx.font = "25px sans-serif";
    ctx.fillStyle = "#000000ff";
    ctx.textAlign = "left";
    ctx.fillText(seat, 110, 310);
    ...
    freeLines.forEach((line, idx) => {
        ctx.fillText(line, 20, 370 + idx * lineHeight);
    });
